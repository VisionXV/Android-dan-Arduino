...
public class printf extends ModuleBody {
    ...
    public class frame11 extends ModuleBody {
            ...
            try {
                                    ...
                                    try {
                                        try {
                                            try {
                                                ...
                                                x = strings.isString$Eq(fdigs, ElementType.MATCH_ANY_LOCALNAME);
                ...
                try {
                    ...
                    if (strip$Mn0s != Boolean.FALSE) {
                        x = strings.isString$Eq(digs, ElementType.MATCH_ANY_LOCALNAME);
        ...
        public Object lambda30formatReal$V(Object signed$Qu, Object sgn, Object digs, Object exp, Object[] argsArray) {
            ...
            if (lists.isNull(rest)) {
                try {
                    ...
                    if (characters.isChar$Eq(printf.Lit5, (Char) sgn)) {
                        ...
                        String str = signed$Qu != Boolean.FALSE ? "+" : this.staticLink.blank != Boolean.FALSE ? " " : ElementType.MATCH_ANY_LOCALNAME;
                    }
                    ...
                    if (x == Boolean.FALSE ? Scheme.isEqv.apply2(this.fc, printf.Lit54) != Boolean.FALSE : x != Boolean.FALSE) {
                        ...
                        if (x == Boolean.FALSE ? Scheme.isEqv.apply2(this.fc, printf.Lit56) != Boolean.FALSE : x != Boolean.FALSE) {
                            ...
                            if (Scheme.isEqv.apply2(this.fc, printf.Lit57) != Boolean.FALSE) {
                                obj3 = ElementType.MATCH_ANY_LOCALNAME;
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    if (uind != Boolean.FALSE) {
                                        exp = AddOp.$Mn.apply2(exp, MultiplyOp.$St.apply2(printf.Lit61, uind));
                                        frame10 gnu_kawa_slib_printf_frame10 = this.staticLink;
                                        Object[] objArr = new Object[2];
                                        objArr[0] = printf.Lit1;
                                        objArr[1] = AddOp.$Mn.apply2(this.staticLink.precision, exp);
                                        gnu_kawa_slib_printf_frame10.precision = numbers.max(objArr);
                                        Object[] objArr2 = new Object[2];
                                        objArr2[0] = lambda29f(digs, exp, Boolean.FALSE);
                                        FVector fVector = printf.Lit62;
                                        apply3 = AddOp.$Pl.apply2(uind, printf.Lit48);
                                        try {
                                            objArr2[1] = LList.list2(obj3, vectors.vectorRef(fVector, ((Number) apply3).intValue()));
                                            lambda29f = append.append$V(objArr2);
                                            return lists.cons(obj, lambda29f);
                                        } catch (ClassCastException e) {
                                ...
                                try {
                                    ...
                                    try {
                                        try {
                                            ...
                                            Object x3 = strings.isString$Eq(fdigs, ElementType.MATCH_ANY_LOCALNAME);
                                            if (x3 == null ? x3 != null : this.staticLink.alternate$Mnform == Boolean.FALSE) {
                                                apply3 = ElementType.MATCH_ANY_LOCALNAME;
                                            } else {
                                                String str3 = ".";
                                            }
                                            lambda29f = this.fc;
                                            try {
                                                try {
                                                    try {
                                                        LList.chain1(LList.chain1(LList.chain4(list1, apply3, fdigs, unicode.isCharUpperCase((Char) lambda29f) ? "E" : "e", numbers.isNegative(LangObjType.coerceRealNum(exp)) ? "-" : "+"), Scheme.numLss.apply3(printf.Lit60, exp, printf.Lit45) != Boolean.FALSE ? "0" : ElementType.MATCH_ANY_LOCALNAME), numbers.number$To$String(numbers.abs((Number) exp)));
                                                        lambda29f = list1;
                                                        return lists.cons(obj, lambda29f);
                                                    } catch (ClassCastException e222) {
            ...
            objArr3[0] = lambda30formatReal$V(signed$Qu, sgn, digs, exp, new Object[0]);
            objArr3[1] = Scheme.apply.apply3(this.format$Mnreal, Boolean.TRUE, rest);
            objArr3[2] = printf.Lit63;
            return append.append$V(objArr3);
        }
    ...
    static {
        ...
        Lit62 = FVector.make("y", "z", "a", "f", "p", "n", "u", "m", ElementType.MATCH_ANY_LOCALNAME, "k", "M", "G", "T", "P", "E", "Z", "Y");
        Lit61 = IntNum.make(3);
